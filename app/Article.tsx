...
export default function Article({ article } : Props){
    return(
        <Link
            ...
            className="col-span-1 flex flex-col items-start justify-start bg-neutral-800 rounded-xl overflow-hidden"
        >
            ...
            <div className="w-full flex flex-grow flex-col items-start justify-start p-4">
                <div                                
                    className="flex flex-row items-center justify-center text-center text-base text-white font-semibold bg-violet-900 px-4 py-2 rounded-2xl border-8 border-neutral-800 mb-2"
                >
